...
function createBodyChildren(reportData = {}) {
  const {
            ...
            new TableCell({
              children: [
                new Paragraph({
                  children: [
                    new TextRun({
                      text: "Insurer Claim No.: " + insurerClaimNo,
                      font: "Arial",
                      size: 24,
                    }),
                  ],
                ...
                new Paragraph({
                  children: [
                    new TextRun({
                      text: "Edme Control No.: " + edmeControlNo,
                      font: "Arial",
                      size: 24,
                    }),
                  ],
...
module.exports = { createBodyChildren };
